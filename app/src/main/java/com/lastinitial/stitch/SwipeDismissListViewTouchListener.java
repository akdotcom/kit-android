...
/**
 * Forked from https://github.com/romannurik/Android-SwipeToDismiss
 *
...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
    ...
    private SwipeDirection mSwipeDirection = SwipeDirection.NEITHER;
    ...
    public interface DismissCallbacks {
         ...
         */
        void onDismiss(ListView listView, int[] reverseSortedPositions, boolean isDimissRight);
    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP: {
                    ...
                    mDownView.animate()
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    performDismiss(downView, downPosition, fDismissRight);
                                }
                            });
                } else {
                    // cancel
                ...
                mDownPosition = ListView.INVALID_POSITION;
                mSwiping = false;
                mSwipeDirection = SwipeDirection.NEITHER;
                break;
            }
...
//    }
    ...
    private void performDismiss(final View dismissView,
        ...
        // Fire the dismiss callback when all dismissed list item animations have completed.
        // This skips the collapsing animation in the original implementation
        mPendingDismisses.add(new PendingDismissData(dismissPosition, dismissView));
        --mDismissAnimationRefCount;
        // No active animations, process all pending dismisses.
        // Sort by descending position
